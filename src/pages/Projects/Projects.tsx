...
// const API_BASE_URL = "http://13.203.56.29:81/v1/api/projects"; // Change to your backend domain
...
//   const navigate = useNavigate();
//   const userId = 1; // Replace with actual user_id from auth

//   // Fetch all projects
//   const fetchProjects = async () => {
//     try {
//       const res = await axios.get(`${API_BASE_URL}/get-projects/:1/`);
...
// const API_BASE_URL = "http://13.203.56.29/v1/api/projects"; // Base URL without extra port
...
//   // ✅ Fetch all projects (Correct API Integration)
//   const fetchProjects = async () => {
//     try {
...
//         status: p.status || "pending", // Adjust based on backend field
...
//             onClick={() =>
//               navigate("/import-api", {
//                 state: { projectId: project.id, projectTitle: project.name },
//               })
//             }
//             className="bg-[#1e1e2e] rounded-lg p-5 shadow border border-gray-700 flex flex-col justify-between 
//             hover:border-blue-500 hover:-translate-y-1 transition-all duration-200 cursor-pointer"

...
const TestCaseRow = ({ test, ref }) => {
    ...
    useEffect(() => {
        // if (test.id === 'new') {
        //     console.log(incrementString(testCases[testCases.length - 2].test_case_id), 'newId')
        //     setTestCaseId(incrementString(testCases[testCases.length-2].test_case_id))
        // }
            ...
            >
                <td className="border border-[#374151] p-3">
                    ...
                    <input type="text" value={testCaseId}
                        ...
                        // placeholder={test.id === 'new' ? 'Enter Test Case ID' : ''}
                ...
                <td className="border border-[#374151] p-3">
                    <div className={test.id === 'new' ? 'border border-[#374151]' : ''}>
                        ...
                        <textarea className="bg-transparent text-[#FFFFFF] border-none outline-none w-full resize-none"
                            ...
                            placeholder={test.id === 'new' ? 'Enter Expected Result' : ''}

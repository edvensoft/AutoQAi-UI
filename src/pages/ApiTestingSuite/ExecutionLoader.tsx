...
const ExecutionLoader = () => {
  ...
  return (
    <Portal>
      <div id="execution-loader" className="fixed inset-0 bg-black bg-opacity-50 z-50">
        <div className="loader-container min-h-screen flex flex-col justify-center items-center relative">
          <style>{`
        @keyframes scaleFade {
          0%, 100% {
            transform: scale(1);

...
//   const options = [
//     {
//       icon: <FileUploadIcon className="text-blue-500 text-4xl" />,
//       title: "Upload Cases",
//       description: "Upload test cases from CSV or Excel files",
//     },
//     {
...
//             <div
//               key={index}
//               className="bg-[#0D0D1A] border border-white rounded-lg p-6 flex flex-col items-center text-center shadow-lg hover:shadow-xl hover:scale-105 transition-all cursor-pointer"
//               onClick={() => {
//                 setTestCase(item.title);
//               }}
//             >
